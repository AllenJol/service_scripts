#!/bin/bash
#__Author__:Allen_Jol at 2018-04-25 11:07:29
#Description: upgrade python to 3.6
...
function python_download(){
  if [ -f "${DIR}/${PYTHON36_SOURCE}" ];then
    ...
    echo -e "Download \e[1;34m${PYTHON36_SOURCE}.tgz\e[0m and config it now,please wait for a moment!"
