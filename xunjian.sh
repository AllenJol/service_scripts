...
IPADDR=$(ifconfig |sed -rn '/inet/s#^.*addr:(.*)  Bcast.*$#\1#gp')
...
function getCronStatus(){
    echo ""
    echo ""
    echo -e "\033[1;31m**************************** 计划任务检查 ****************************\033[0m"
    Crontab=0
...
function getSudoersStatus(){
    echo ""
    echo ""
    echo -e "\033[1;31m**************************** Sudoers检查 ****************************\033[0m"
...
function getSyslogStatus(){
    echo ""
    echo ""
    echo -e "\033[1;31m**************************** syslog检查 ****************************\033[0m"
...
function getSNMPStatus(){
    ...
    echo ""
    echo ""
    echo -e "\033[1;31m**************************** SNMP检查 ****************************\033[0m"
